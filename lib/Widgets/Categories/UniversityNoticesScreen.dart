...
class Universitynoticesscreen extends StatelessWidget {
  const Universitynoticesscreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("University Notices", style: TextStyle(fontSize: 24)),
      ),
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('KU-Notices')
            .where('category', isEqualTo: 'University Notices')
            .snapshots(),
